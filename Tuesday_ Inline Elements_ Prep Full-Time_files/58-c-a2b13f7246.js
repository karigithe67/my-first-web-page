(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[58,571],{"0crz":function(e,t,n){"use strict"
var a=n("ouhR")
var i=n.n(a)
var r=n("pQTu")
var o=n("m0r6")
...
l=[]
o.push(a)}}l.length&&o.push(d.quoteClump(l))
...
n=Math.floor(n/1e3)
i=a+i}return r+String(n)+i},truncateText:function(e,t){var n,a,i,r,o,s
null==t&&(t={})
a=null!=(r=t.max)?r:30
n=l.t("ellipsis","...")
...
o=i}o||(o=a-n.length)
return e.substring(0,o)+n}}},B1vq:function(e,t,n){"use strict"
var a=n("ouhR")
var i=n.n(a)
n("s/PJ")
n("c6Pp")
...
var a=n.offset(),r=n.outerWidth(),o=n.outerHeight(),l=a.top,s=l+o,c=a.left,u=c+r,d="html,body"==this.selector?i.a.windowScrollTop():this.scrollTop(),_=this.scrollLeft(),h=this.outerHeight(),f=this.outerWidth()
...
c-=_
s-=d
u-=_}l<0||h<o&&s>h?t.scrollTop=l+d:s>h&&(t.scrollTop=s+d-h+20)
...
var i=n.n(a)
n("rEd+")
function r(){return i()(".vdd_tooltip_link").tooltip({position:{my:"center bottom",at:"center top-10",collision:"fit fit"},tooltipClass:"center bottom vertical",content:function(){var e=i()(this).data("tooltipSelector")
...
l.a.ajaxJSON(e.url,"DELETE",i,function(n){e.success.call(t,n)},function(n,a,i,r){e.error&&l.a.isFunction(e.error)?e.error.call(t,n,a,i,r):l.a.ajaxJSON.unhandledXHRs.push(a)})}else{e.success||(e.success=function(){t.fadeOut("slow",function(){t.remove()})})
e.success.call(t)}}
if(e.message&&!e.noMessage&&!l.a.skipConfirmations){if(e.dialog){a=false
var o="object"==typeof e.dialog?e.dialog:{}
n=l()(e.message).dialog(l.a.extend({},{modal:true,close:i,buttons:[{text:r.t("#buttons.cancel","Cancel"),click:function(){l()(this).dialog("close")}},{text:r.t("#buttons.delete","Delete"),class:"btn-primary",click:function(){a=true
l()(this).dialog("close")}}]},o))
...
s.doc[0]==r[0]&&(o=true)}o||l.a._checkFragments.fragmentList.push({doc:r,fragment:""})
...
return this}
l.a.fn.fillWindowWithMe=function(e){var t=l.a.extend({minHeight:400},e),n=l()(this),a=l()("#wrapper"),i=l()("#main"),r=l()("#not_right_side"),o=l()(window),s=l()(this).add(t.alsoResize)
...
i.text(n)
var r=i.width(),o=r+e.comfortZone>=t?r+e.comfortZone:t,l=a.width(),s=o<l&&o>=t||o>t&&o<e.maxWidth
s&&a.width(o)})}
i.insertAfter(a)
...
//# sourceMappingURL=58-c-a2b13f7246.js.map