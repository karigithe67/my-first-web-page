...
c.prototype.setLockState=function(e){return a.a.ajaxJSON("/api/v1/courses/"+this.course_id+"/blueprint_templates/default/restrict_item","PUT",{content_type:this.content_type,content_id:this.content_id,restricted:e},(c=this,function(o){c.model.set("restricted_by_master_course",e)
...
c.prototype.closeTooltip=function(){return a()(".ui-tooltip").remove()}
...
var n={points:{label:r.t("points"),key:"points"},percent:{label:r.t("percent"),key:"percent"},letter_grade:{label:r.t("letter grade"),key:"letter_grade"},gpa_scale:{label:r.t("GPA scale"),key:"gpa_scale"},other:{label:r.t("other"),key:"other"}}
var a=n
...
o.d(c,"a",function(){return v})
var s=function(e){var c=i["a"].parse(e)
return!isNaN(c)&&isFinite(c)}
var d=function(e){return!!e&&!!e.grading_scheme}
var k=function(e){var c=e?e.grading_type:a.percent.key
if((c===a.letter_grade.key||c===a.gpa_scale.key)&&!d(e))return a.percent.key
return c}
var p=function(e,c){var o=k(c)
return o===a.points.key?f(e,c):o===a.letter_grade.key||o===a.gpa_scale.key?g(e,c):h(e)}
var u=function(e,c,o){e||(e=o?"1":"0")
return b(p(e,c),c)}
var b=function(e,c){var o=k(c)
return o===a.points.key?_.t("%{score} pts",{score:_.n(e,{precision:2,strip_insignificant_zeros:true})}):o===a.letter_grade.key||o===a.gpa_scale.key?e:_.n(e,{precision:2,percentage:true,strip_insignificant_zeros:true})}
var f=function(e,c){if(!s(e))return e
if(0===e)return"0"
var o=i["a"].parse(e)
var t=Number(c.points_possible)||100
return parseFloat((o*t).toFixed(2))}
var g=function(e,c){if(""===e)return""
var o=i["a"].parse(e)
var t={letter:null,score:-Infinity}
for(var l in c.grading_scheme){var r=i["a"].parse(c.grading_scheme[l])
if(r<=o&&r>t.score||0===r&&r>o){t.score=r
t.letter=l}}return t.letter?t.letter:o}
var h=function(e){if(!s(e))return e
return Math.floor(100*e)}
var v=function(e,c){if("string"===typeof e&&c.grading_type!==a.letter_grade.key&&c.grading_type!==a.gpa_scale.key){var o=i["a"].parse(e.replace(/%$/,""))
...
var n=o("MdYG")
var a=function(){return ENV.CONDITIONAL_RELEASE_SERVICE_ENABLED||false}
var _=function(){var e=ENV.CONDITIONAL_RELEASE_ENV&&ENV.CONDITIONAL_RELEASE_ENV.active_rules||[]
return{triggerAssignments:e.reduce(function(e,c){e[c.trigger_assignment]=c
return e},{}),releasedAssignments:e.reduce(function(e,c){c.scoring_ranges.forEach(function(o){o.assignment_sets.forEach(function(t){t.assignments.forEach(function(t){var l=t.assignment_id
e[l]=e[l]||[]
...
var k=function(e){var c=i.releasedAssignments[e]||[]
if(c.length>1)return r.t("Multiple")
if(c.length>0){var o=c[0]
return r.t("%{upper} - %{lower}",{upper:Object(n["b"])(o.upper_bound,o.assignment,true),lower:Object(n["b"])(o.lower_bound,o.assignment,false)})}return null}
c["a"]={isEnabled:a,reloadEnv:function(){i=_()},getItemData:function(e){var c=!(arguments.length>1&&void 0!==arguments[1])||arguments[1]
e=e&&e.toString()
return a()?{isCyoeAble:e&&c,isTrigger:e&&c&&s(e),isReleased:d(e),releasedLabel:k(e)}:{}}}}}])

//# sourceMappingURL=53-c-7ab7046566.js.map